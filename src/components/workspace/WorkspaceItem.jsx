...
export default function WorkspaceItem({ board, isMenuOpen, color, onDelete, onEdit }) {
    ...
    return (
        <div className="relative">
            <a href="#" className={`${isMenuOpen ? "pl-12" : "pl-6"} pb-2 pt-2 text-gray-900 font-bold flex flex-row content-center focus:outline-none transition-colors duration-1000 rounded-lg dark:text-white dark:hover:bg-gray-800 hover:bg-gray-100`}>
                ...
                {isMenuOpen && (
                    <button
                        ...
                        className="ml-auto mr-2 text-gray-500 hover:text-gray-700 dark:text-white dark:hover:text-gray-200"
                    >
